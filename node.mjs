...
;
	($.$bog_quest_home) = class $bog_quest_home extends ($.$mol_list) {
		Title_text(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_home_Title_text_title")));
			return obj;
		}
		create_game(next){
			if(next !== undefined) return next;
		...
		Create_button(){
			...
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_home_Create_button_title")));
			(obj.click) = (next) => ((this.create_game(next)));
			return obj;
		}
		game_rows(){
			return [];
		...
		Saves_header(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_home_Saves_header_title")));
			return obj;
		}
		save_rows(){
			return [];
		...
		Edit_label(){
			return (this.$.$mol_locale.text("$bog_quest_home_Edit_label"));
		}
		Edit_link(id){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"screen": "edit", "game": (this.game_id(id))});
			(obj.sub) = () => ([(this.Edit_label())]);
			return obj;
		}
		share_game(id, next){
			if(next !== undefined) return next;
		...
		Share_link(id){
			...
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_home_Share_link_title")));
			(obj.click) = (next) => ((this.share_game(id, next)));
			return obj;
		}
		delete_game(id, next){
			if(next !== undefined) return next;
		...
		Delete_button(id){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_home_Delete_button_title")));
			(obj.click) = (next) => ((this.delete_game(id, next)));
			return obj;
		}
		save_title(id){
			return "";
		...
		Continue_label(){
			return (this.$.$mol_locale.text("$bog_quest_home_Continue_label"));
		}
		Continue_link(id){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({
				"screen": "play", 
				"author": (this.save_author(id)), 
				"game": (this.save_game(id))
			});
			(obj.sub) = () => ([(this.Continue_label())]);
			return obj;
		}
		delete_save(id, next){
			if(next !== undefined) return next;
		...
		Save_delete_button(id){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_home_Save_delete_button_title")));
			(obj.click) = (next) => ((this.delete_save(id, next)));
			return obj;
		}
		rows(){
			return [
		...
		Save_card(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([
				(this.Save_title_label(id)), 
				(this.Continue_link(id)), 
				(this.Save_delete_button(id))
			]);
			return obj;
		}
	};
	($mol_mem(($.$bog_quest_home.prototype), "Title_text"));
	($mol_mem(($.$bog_quest_home.prototype), "create_game"));
	($mol_mem(($.$bog_quest_home.prototype), "Create_button"));
	($mol_mem(($.$bog_quest_home.prototype), "Games_list"));
	($mol_mem(($.$bog_quest_home.prototype), "Saves_header"));
	($mol_mem(($.$bog_quest_home.prototype), "Saves_list"));
	($mol_mem_key(($.$bog_quest_home.prototype), "Game_title_label"));
	($mol_mem_key(($.$bog_quest_home.prototype), "Edit_link"));
	($mol_mem_key(($.$bog_quest_home.prototype), "share_game"));
	($mol_mem_key(($.$bog_quest_home.prototype), "Share_link"));
	($mol_mem_key(($.$bog_quest_home.prototype), "delete_game"));
	($mol_mem_key(($.$bog_quest_home.prototype), "Delete_button"));
	($mol_mem_key(($.$bog_quest_home.prototype), "Save_title_label"));
	($mol_mem_key(($.$bog_quest_home.prototype), "Continue_link"));
	($mol_mem_key(($.$bog_quest_home.prototype), "delete_save"));
	($mol_mem_key(($.$bog_quest_home.prototype), "Save_delete_button"));
	($mol_mem_key(($.$bog_quest_home.prototype), "Game_card"));
	($mol_mem_key(($.$bog_quest_home.prototype), "Save_card"));
...
(function ($) {
    ...
    $.$bog_quest_scene = $bog_quest_scene;
})($ || ($ = {}));
...
(function ($) {
    ...
    class $bog_quest_character extends $giper_baza_dict.with({
        Name: $giper_baza_atom_text,
        Color: $giper_baza_atom_text,
        Sprite: $giper_baza_atom_link_to(() => $giper_baza_file),
    }) {
    }
    $.$bog_quest_character = $bog_quest_character;
})($ || ($ = {}));
...
(function ($) {
     ...
     */
    class $bog_quest_game extends $giper_baza_dict.with({
        Title: $giper_baza_atom_text,
...
(function ($) {
     ...
     */
    class $bog_quest_save extends $giper_baza_dict.with({
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_quest_home extends $.$bog_quest_home {
        ...
        __decorate([
            $mol_mem
        ], $bog_quest_home.prototype, "store", null);
        __decorate([
            $mol_mem
        ], $bog_quest_home.prototype, "games", null);
        __decorate([
            $mol_mem
        ], $bog_quest_home.prototype, "game_rows", null);
        __decorate([
            $mol_action
        ], $bog_quest_home.prototype, "create_game", null);
        __decorate([
            $mol_action
        ], $bog_quest_home.prototype, "share_game", null);
        __decorate([
            $mol_action
        ], $bog_quest_home.prototype, "delete_game", null);
        __decorate([
            $mol_mem
        ], $bog_quest_home.prototype, "saves", null);
        __decorate([
            $mol_mem
        ], $bog_quest_home.prototype, "save_rows", null);
        __decorate([
            $mol_action
        ], $bog_quest_home.prototype, "delete_save", null);
        $$.$bog_quest_home = $bog_quest_home;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_quest_editor_scene) = class $bog_quest_editor_scene extends ($.$mol_list) {
		scene_rows(){
			return [];
		}
		scene_title(next){
		...
		Line_character(id){
			...
			(obj.value) = (next) => ((this.line_character(id, next)));
			(obj.dictionary) = () => ((this.character_options()));
			return obj;
		}
		line_position(id, next){
			if(next !== undefined) return next;
			return "center";
		}
		Line_position(id){
			const obj = new this.$.$mol_select();
			(obj.value) = (next) => ((this.line_position(id, next)));
			(obj.dictionary) = () => ({
				"left": (this.$.$mol_locale.text("$bog_quest_editor_scene_Line_position_dictionary_left")), 
				"center": (this.$.$mol_locale.text("$bog_quest_editor_scene_Line_position_dictionary_center")), 
				"right": (this.$.$mol_locale.text("$bog_quest_editor_scene_Line_position_dictionary_right"))
			});
			return obj;
		}
		line_text(id, next){
		...
		Line_text(id){
			...
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_quest_editor_scene_Line_text_hint")));
			(obj.value) = (next) => ((this.line_text(id, next)));
			return obj;
		}
		line_delete(id, next){
			if(next !== undefined) return next;
		...
		Line_delete(id){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_scene_Line_delete_title")));
			(obj.click) = (next) => ((this.line_delete(id, next)));
			return obj;
		}
		add_choice(next){
			if(next !== undefined) return next;
		...
		Choice_text(id){
			const obj = new this.$.$mol_string();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_quest_editor_scene_Choice_text_hint")));
			(obj.value) = (next) => ((this.choice_text(id, next)));
			return obj;
		}
		choice_next(id, next){
			if(next !== undefined) return next;
		...
		Choice_next(id){
			const obj = new this.$.$mol_select();
			(obj.value) = (next) => ((this.choice_next(id, next)));
			(obj.dictionary) = () => ((this.scene_options()));
			return obj;
		}
		choice_delete(id, next){
			if(next !== undefined) return next;
			return null;
		}
		Choice_delete(id){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_scene_Choice_delete_title")));
			(obj.click) = (next) => ((this.choice_delete(id, next)));
			return obj;
		}
		game_link(){
			return "";
		...
		rows(){
			return (this.scene_rows());
		}
		Scene_title(){
			const obj = new this.$.$mol_string();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_quest_editor_scene_Scene_title_hint")));
			(obj.value) = (next) => ((this.scene_title(next)));
			return obj;
		}
		Bg_section(){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ((this.bg_section()));
			return obj;
		}
		Bg_preview(){
		...
		Bg_upload(){
			...
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_scene_Bg_upload_title")));
			(obj.files) = (next) => ((this.bg_files(next)));
			return obj;
		}
		Bg_remove(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_scene_Bg_remove_title")));
			(obj.click) = (next) => ((this.bg_remove(next)));
			return obj;
		}
		Lines_header(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_scene_Lines_header_title")));
			return obj;
		}
		Add_line(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_scene_Add_line_title")));
			(obj.click) = (next) => ((this.add_line(next)));
			return obj;
		}
		Line_row(id){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ([
				(this.Line_character(id)), 
				(this.Line_position(id)), 
				(this.Line_text(id)), 
				(this.Line_delete(id))
			]);
			return obj;
		...
		Choices_header(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_scene_Choices_header_title")));
			return obj;
		}
		Add_choice(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_scene_Add_choice_title")));
			(obj.click) = (next) => ((this.add_choice(next)));
			return obj;
		}
		Choice_row(id){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ([
				(this.Choice_text(id)), 
				(this.Choice_next(id)), 
				(this.Choice_delete(id))
			]);
			return obj;
		}
	};
	($mol_mem(($.$bog_quest_editor_scene.prototype), "scene_title"));
	($mol_mem(($.$bog_quest_editor_scene.prototype), "bg_files"));
	($mol_mem(($.$bog_quest_editor_scene.prototype), "bg_remove"));
	($mol_mem(($.$bog_quest_editor_scene.prototype), "add_line"));
	($mol_mem_key(($.$bog_quest_editor_scene.prototype), "line_character"));
	($mol_mem_key(($.$bog_quest_editor_scene.prototype), "Line_character"));
	($mol_mem_key(($.$bog_quest_editor_scene.prototype), "line_position"));
	($mol_mem_key(($.$bog_quest_editor_scene.prototype), "Line_position"));
	($mol_mem_key(($.$bog_quest_editor_scene.prototype), "line_text"));
	($mol_mem_key(($.$bog_quest_editor_scene.prototype), "Line_text"));
	($mol_mem_key(($.$bog_quest_editor_scene.prototype), "line_delete"));
	($mol_mem_key(($.$bog_quest_editor_scene.prototype), "Line_delete"));
	($mol_mem(($.$bog_quest_editor_scene.prototype), "add_choice"));
	($mol_mem_key(($.$bog_quest_editor_scene.prototype), "choice_text"));
	($mol_mem_key(($.$bog_quest_editor_scene.prototype), "Choice_text"));
	($mol_mem_key(($.$bog_quest_editor_scene.prototype), "choice_next"));
	($mol_mem_key(($.$bog_quest_editor_scene.prototype), "Choice_next"));
	($mol_mem_key(($.$bog_quest_editor_scene.prototype), "choice_delete"));
	($mol_mem_key(($.$bog_quest_editor_scene.prototype), "Choice_delete"));
	($mol_mem(($.$bog_quest_editor_scene.prototype), "Scene_title"));
	($mol_mem(($.$bog_quest_editor_scene.prototype), "Bg_section"));
	($mol_mem(($.$bog_quest_editor_scene.prototype), "Bg_preview"));
	($mol_mem(($.$bog_quest_editor_scene.prototype), "Bg_upload"));
	($mol_mem(($.$bog_quest_editor_scene.prototype), "Bg_remove"));
	($mol_mem(($.$bog_quest_editor_scene.prototype), "Lines_header"));
	($mol_mem(($.$bog_quest_editor_scene.prototype), "Add_line"));
	($mol_mem_key(($.$bog_quest_editor_scene.prototype), "Line_row"));
	($mol_mem(($.$bog_quest_editor_scene.prototype), "Choices_header"));
	($mol_mem(($.$bog_quest_editor_scene.prototype), "Add_choice"));
	($mol_mem_key(($.$bog_quest_editor_scene.prototype), "Choice_row"));
...
(function ($) {
     ...
     */
    class $bog_quest_home_ref extends $giper_baza_dict.with({
        Author_land: $giper_baza_atom_text,
        Saves_land: $giper_baza_atom_text,
    }) {
    }
    $.$bog_quest_home_ref = $bog_quest_home_ref;
    /** Реестр игр автора, лежит в public-read author-ленде. */
    class $bog_quest_registry extends $giper_baza_dict.with({
        Games: $giper_baza_list_link_to(() => $bog_quest_game),
    }) {
    }
    $.$bog_quest_registry = $bog_quest_registry;
    /** Список сейвов игрока, лежит в приватном saves-ленде. */
    class $bog_quest_saves extends $giper_baza_dict.with({
        Items: $giper_baza_list_link_to(() => $bog_quest_save),
    }) {
    }
    $.$bog_quest_saves = $bog_quest_saves;
    class $bog_quest_store extends $mol_object {
        glob() {
        ...
        home_ref() {
            return this.home_land().Data($bog_quest_home_ref);
        }
        ...
        author_land() {
            ...
            if (!link_str)
                return this.author_land_make();
            return this.glob().Land(new $giper_baza_link(link_str));
        }
        registry() {
            return this.author_land().Data($bog_quest_registry);
        }
        ...
        saves_land() {
            ...
            if (!link_str)
                return this.saves_land_make();
            return this.glob().Land(new $giper_baza_link(link_str));
        }
        saves() {
            return this.saves_land().Data($bog_quest_saves);
        }
        /** Загрузить чужой author ленд по link-строке (для player режима). */
        foreign_author(link_str) {
            const land = this.glob().Land(new $giper_baza_link(link_str));
            return land.Data($bog_quest_registry);
        }
    }
    __decorate([
        $mol_action
    ], $bog_quest_store.prototype, "author_land_make", null);
    __decorate([
        $mol_mem
    ], $bog_quest_store.prototype, "author_land", null);
    __decorate([
        $mol_mem
    ], $bog_quest_store.prototype, "registry", null);
    __decorate([
        $mol_action
    ], $bog_quest_store.prototype, "saves_land_make", null);
    __decorate([
        $mol_mem
    ], $bog_quest_store.prototype, "saves_land", null);
    __decorate([
        $mol_mem
    ], $bog_quest_store.prototype, "saves", null);
    $.$bog_quest_store = $bog_quest_store;
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_quest_editor_scene extends $.$bog_quest_editor_scene {
            store() { return $bog_quest_store.make({ $: this.$ }); }
            game() {
                ...
                return (games.find(g => g.link().str === link) ?? null);
            }
            scene() {
                ...
                return (scenes.find(s => s.link().str === key) ?? null);
            }
            scene_rows() {
                if (!this.scene())
                    return [];
            ...
            line_at(key) { return this.lines()[Number(key)]; }
            line_character(key, next) {
                const l = this.line_at(key);
                if (!l)
                    return '';
                if (next !== undefined) {
                    l.Character_id('auto')?.val(next);
                    return next;
                }
                return l.Character_id()?.val() ?? '';
            }
            line_position(key, next) {
                const l = this.line_at(key);
                if (!l)
                    return 'center';
                if (next !== undefined) {
                    l.Position('auto')?.val(next);
                    return next;
                }
            ...
            choice_at(key) { return this.choices()[Number(key)]; }
            choice_text(key, next) {
                const c = this.choice_at(key);
                if (!c)
                    return '';
                if (next !== undefined) {
                    c.Text('auto')?.val(next);
                    return next;
                }
                return c.Text()?.val() ?? '';
            }
            choice_next(key, next) {
                const c = this.choice_at(key);
                if (!c)
                    return '';
                if (next !== undefined) {
                    c.Next_scene_id('auto')?.val(next);
                    return next;
                }
        ...
        __decorate([
            $mol_mem
        ], $bog_quest_editor_scene.prototype, "store", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor_scene.prototype, "game", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor_scene.prototype, "scene", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor_scene.prototype, "scene_rows", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor_scene.prototype, "bg_section", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor_scene.prototype, "scene_title", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor_scene.prototype, "bg_uri", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor_scene.prototype, "bg_files", null);
        __decorate([
            $mol_action
        ], $bog_quest_editor_scene.prototype, "bg_remove", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor_scene.prototype, "character_options", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor_scene.prototype, "scene_options", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor_scene.prototype, "lines", null);
        __decorate([
            $mol_mem_key
        ], $bog_quest_editor_scene.prototype, "line_character", null);
        __decorate([
            $mol_mem_key
        ], $bog_quest_editor_scene.prototype, "line_position", null);
        __decorate([
            $mol_mem_key
        ], $bog_quest_editor_scene.prototype, "line_text", null);
        __decorate([
            $mol_action
        ], $bog_quest_editor_scene.prototype, "line_delete", null);
        __decorate([
            $mol_action
        ], $bog_quest_editor_scene.prototype, "add_line", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor_scene.prototype, "choices", null);
        __decorate([
            $mol_mem_key
        ], $bog_quest_editor_scene.prototype, "choice_text", null);
        __decorate([
            $mol_mem_key
        ], $bog_quest_editor_scene.prototype, "choice_next", null);
        __decorate([
            $mol_action
        ], $bog_quest_editor_scene.prototype, "choice_delete", null);
        __decorate([
            $mol_action
        ], $bog_quest_editor_scene.prototype, "add_choice", null);
        $$.$bog_quest_editor_scene = $bog_quest_editor_scene;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));

;
	($.$bog_quest_editor_graph) = class $bog_quest_editor_graph extends ($.$mol_view) {
		viewbox(){
			return "0 0 1200 800";
		}
		graph_sub(){
		...
		Node_label(id){
			...
			(obj.sub) = () => ([(this.node_label(id))]);
			return obj;
		}
		Arrow_path(){
			const obj = new this.$.$mol_view();
			(obj.dom_name) = () => ("path");
			(obj.attr) = () => ({"d": "M0 0 L10 5 L0 10 z", "fill": "#888"});
			return obj;
		}
		Arrow_marker(){
			const obj = new this.$.$mol_view();
		...
		attr(){
			return {"viewBox": (this.viewbox()), "xmlns": "http://www.w3.org/2000/svg"};
		}
		sub(){
			return (this.graph_sub());
		}
		Edge(id){
			const obj = new this.$.$mol_view();
			(obj.dom_name) = () => ("line");
		...
		Node_group(id){
			const obj = new this.$.$mol_view();
			(obj.dom_name) = () => ("g");
			(obj.attr) = () => ({"transform": (this.node_transform(id))});
			(obj.event) = () => ({"click": (next) => (this.node_click(id, next))});
			(obj.sub) = () => ([(this.Node_rect(id)), (this.Node_label(id))]);
			return obj;
		}
		Arrow_defs(){
			const obj = new this.$.$mol_view();
			(obj.dom_name) = () => ("defs");
			(obj.sub) = () => ([(this.Arrow_marker())]);
			return obj;
		}
	};
	($mol_mem_key(($.$bog_quest_editor_graph.prototype), "node_click"));
	($mol_mem_key(($.$bog_quest_editor_graph.prototype), "Node_rect"));
	($mol_mem_key(($.$bog_quest_editor_graph.prototype), "Node_label"));
	($mol_mem(($.$bog_quest_editor_graph.prototype), "Arrow_path"));
	($mol_mem(($.$bog_quest_editor_graph.prototype), "Arrow_marker"));
	($mol_mem_key(($.$bog_quest_editor_graph.prototype), "Edge"));
	($mol_mem_key(($.$bog_quest_editor_graph.prototype), "Node_group"));
	($mol_mem(($.$bog_quest_editor_graph.prototype), "Arrow_defs"));
...
(function ($) {
    ...
    (function ($$) {
        const NODE_W = 180;
        const NODE_H = 80;
        class $bog_quest_editor_graph extends $.$bog_quest_editor_graph {
            store() { return $bog_quest_store.make({ $: this.$ }); }
            game() {
                const link = this.game_link();
                if (!link)
            ...
            viewbox() {
                ...
                for (const p of this.scene_pos().values()) {
                    if (p.x + NODE_W + 40 > max_x)
                        max_x = p.x + NODE_W + 40;
                    if (p.y + NODE_H + 40 > max_y)
                        max_y = p.y + NODE_H + 40;
                }
            ...
            edge_x1(key) {
                const e = this.edges()[Number(key)];
                if (!e)
                    return 0;
                const p = this.scene_pos().get(e.from);
                return p ? p.x + NODE_W : 0;
            }
            edge_y1(key) {
                const e = this.edges()[Number(key)];
                if (!e)
            ...
            edge_x2(key) {
                ...
                if (!e)
                    return 0;
                const p = this.scene_pos().get(e.to);
                return p ? p.x : 0;
            }
            edge_y2(key) {
                const e = this.edges()[Number(key)];
            ...
            scene_at(key) { return this.scenes()[Number(key)]; }
            node_transform(key) {
                const sc = this.scene_at(key);
                if (!sc)
                    return 'translate(0 0)';
                const x = sc.Pos_x()?.val() ?? 0;
                const y = sc.Pos_y()?.val() ?? 0;
        ...
        __decorate([
            $mol_mem
        ], $bog_quest_editor_graph.prototype, "store", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor_graph.prototype, "game", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor_graph.prototype, "scenes", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor_graph.prototype, "scene_pos", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor_graph.prototype, "viewbox", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor_graph.prototype, "edges", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor_graph.prototype, "graph_sub", null);
        __decorate([
            $mol_action
        ], $bog_quest_editor_graph.prototype, "node_click", null);
        $$.$bog_quest_editor_graph = $bog_quest_editor_graph;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
var $;
(function ($) {
    $mol_style_define($bog_quest_editor_graph, {
        display: 'block',
        width: '100%',
        minHeight: '70vh',
...
;
	($.$bog_quest_editor) = class $bog_quest_editor extends ($.$mol_list) {
		editor_rows(){
			return [];
		}
		game_title(next){
		...
		character_name(id, next){
			if(next !== undefined) return next;
			return "";
		}
		Character_name(id){
			const obj = new this.$.$mol_string();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_quest_editor_Character_name_hint")));
			(obj.value) = (next) => ((this.character_name(id, next)));
			return obj;
		}
		character_color(id, next){
			if(next !== undefined) return next;
			return "";
		}
		Character_color(id){
			const obj = new this.$.$mol_string();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_quest_editor_Character_color_hint")));
			(obj.value) = (next) => ((this.character_color(id, next)));
			return obj;
		}
		character_sprite_files(id, next){
			if(next !== undefined) return next;
			return [];
		}
		Character_sprite_upload(id){
			const obj = new this.$.$mol_button_open();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_Character_sprite_upload_title")));
			(obj.files) = (next) => ((this.character_sprite_files(id, next)));
			return obj;
		}
		character_sprite_uri(id){
			return "";
		}
		Character_sprite_image(id){
			const obj = new this.$.$mol_image();
			(obj.uri) = () => ((this.character_sprite_uri(id)));
			return obj;
		}
		character_delete(id, next){
			if(next !== undefined) return next;
			return null;
		}
		Character_delete(id){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_Character_delete_title")));
			(obj.click) = (next) => ((this.character_delete(id, next)));
			return obj;
		}
		add_scene(next){
			if(next !== undefined) return next;
		...
		Graph_label(){
			return (this.$.$mol_locale.text("$bog_quest_editor_Graph_label"));
		}
		scene_key(id){
			return "";
		}
		...
		Scene_link(id){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"scene": (this.scene_key(id))});
			(obj.sub) = () => ([(this.scene_title(id))]);
			return obj;
		}
		scene_start_label(id){
			return "";
		}
		Scene_start_label(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.scene_start_label(id))]);
			return obj;
		}
		scene_set_start(id, next){
			if(next !== undefined) return next;
			return null;
		}
		Scene_set_start(id){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_Scene_set_start_title")));
			(obj.click) = (next) => ((this.scene_set_start(id, next)));
			return obj;
		}
		scene_delete(id, next){
			if(next !== undefined) return next;
			return null;
		}
		Scene_delete(id){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_Scene_delete_title")));
			(obj.click) = (next) => ((this.scene_delete(id, next)));
			return obj;
		}
		Back_label(){
			return (this.$.$mol_locale.text("$bog_quest_editor_Back_label"));
		}
		game_link(){
			return "";
		}
		...
		Game_title(){
			const obj = new this.$.$mol_string();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_quest_editor_Game_title_hint")));
			(obj.value) = (next) => ((this.game_title(next)));
			return obj;
		}
		Game_author(){
			const obj = new this.$.$mol_string();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_quest_editor_Game_author_hint")));
			(obj.value) = (next) => ((this.game_author(next)));
			return obj;
		}
		Game_description(){
			const obj = new this.$.$mol_textarea();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_quest_editor_Game_description_hint")));
			(obj.value) = (next) => ((this.game_description(next)));
			return obj;
		}
		Cover_section(){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ((this.cover_section()));
			return obj;
		}
		Cover_preview(){
			const obj = new this.$.$mol_image();
			(obj.uri) = () => ((this.cover_uri()));
			return obj;
		}
		Cover_upload(){
			const obj = new this.$.$mol_button_open();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_Cover_upload_title")));
			(obj.files) = (next) => ((this.cover_files(next)));
			return obj;
		}
		Cover_remove(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_Cover_remove_title")));
			(obj.click) = (next) => ((this.cover_remove(next)));
			return obj;
		}
		Characters_header(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_Characters_header_title")));
			return obj;
		}
		Add_character(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_Add_character_title")));
			(obj.click) = (next) => ((this.add_character(next)));
			return obj;
		}
		Character_row(id){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ([
				(this.Character_name(id)), 
				(this.Character_color(id)), 
				(this.Character_sprite_upload(id)), 
				(this.Character_sprite_image(id)), 
				(this.Character_delete(id))
			]);
			return obj;
		}
		Scenes_header(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_Scenes_header_title")));
			return obj;
		}
		Add_scene(){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_Add_scene_title")));
			(obj.click) = (next) => ((this.add_scene(next)));
			return obj;
		}
		Graph_link(){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"panel": "graph"});
			(obj.sub) = () => ([(this.Graph_label())]);
			return obj;
		}
		Scene_row(id){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ([
				(this.Scene_link(id)), 
				(this.Scene_start_label(id)), 
				(this.Scene_set_start(id)), 
				(this.Scene_delete(id))
			]);
			return obj;
		}
		No_game(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_editor_No_game_title")));
			return obj;
		}
		Back_link(){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"scene": null, "panel": null});
			(obj.sub) = () => ([(this.Back_label())]);
			return obj;
		}
		Scene_editor(){
			const obj = new this.$.$bog_quest_editor_scene();
			(obj.game_link) = () => ((this.game_link()));
			(obj.scene_key) = () => ((this.current_scene_key()));
			return obj;
		}
		Graph_view(){
			const obj = new this.$.$bog_quest_editor_graph();
			(obj.game_link) = () => ((this.game_link()));
			return obj;
		}
	};
	($mol_mem(($.$bog_quest_editor.prototype), "game_title"));
	($mol_mem(($.$bog_quest_editor.prototype), "game_author"));
	($mol_mem(($.$bog_quest_editor.prototype), "game_description"));
	($mol_mem(($.$bog_quest_editor.prototype), "cover_files"));
	($mol_mem(($.$bog_quest_editor.prototype), "cover_remove"));
	($mol_mem(($.$bog_quest_editor.prototype), "add_character"));
	($mol_mem_key(($.$bog_quest_editor.prototype), "character_name"));
	($mol_mem_key(($.$bog_quest_editor.prototype), "Character_name"));
	($mol_mem_key(($.$bog_quest_editor.prototype), "character_color"));
	($mol_mem_key(($.$bog_quest_editor.prototype), "Character_color"));
	($mol_mem_key(($.$bog_quest_editor.prototype), "character_sprite_files"));
	($mol_mem_key(($.$bog_quest_editor.prototype), "Character_sprite_upload"));
	($mol_mem_key(($.$bog_quest_editor.prototype), "Character_sprite_image"));
	($mol_mem_key(($.$bog_quest_editor.prototype), "character_delete"));
	($mol_mem_key(($.$bog_quest_editor.prototype), "Character_delete"));
	($mol_mem(($.$bog_quest_editor.prototype), "add_scene"));
	($mol_mem_key(($.$bog_quest_editor.prototype), "Scene_link"));
	($mol_mem_key(($.$bog_quest_editor.prototype), "Scene_start_label"));
	($mol_mem_key(($.$bog_quest_editor.prototype), "scene_set_start"));
	($mol_mem_key(($.$bog_quest_editor.prototype), "Scene_set_start"));
	($mol_mem_key(($.$bog_quest_editor.prototype), "scene_delete"));
	($mol_mem_key(($.$bog_quest_editor.prototype), "Scene_delete"));
	($mol_mem(($.$bog_quest_editor.prototype), "Game_title"));
	($mol_mem(($.$bog_quest_editor.prototype), "Game_author"));
	($mol_mem(($.$bog_quest_editor.prototype), "Game_description"));
	($mol_mem(($.$bog_quest_editor.prototype), "Cover_section"));
	($mol_mem(($.$bog_quest_editor.prototype), "Cover_preview"));
	($mol_mem(($.$bog_quest_editor.prototype), "Cover_upload"));
	($mol_mem(($.$bog_quest_editor.prototype), "Cover_remove"));
	($mol_mem(($.$bog_quest_editor.prototype), "Characters_header"));
	($mol_mem(($.$bog_quest_editor.prototype), "Add_character"));
	($mol_mem_key(($.$bog_quest_editor.prototype), "Character_row"));
	($mol_mem(($.$bog_quest_editor.prototype), "Scenes_header"));
	($mol_mem(($.$bog_quest_editor.prototype), "Add_scene"));
	($mol_mem(($.$bog_quest_editor.prototype), "Graph_link"));
	($mol_mem_key(($.$bog_quest_editor.prototype), "Scene_row"));
	($mol_mem(($.$bog_quest_editor.prototype), "No_game"));
	($mol_mem(($.$bog_quest_editor.prototype), "Back_link"));
	($mol_mem(($.$bog_quest_editor.prototype), "Scene_editor"));
	($mol_mem(($.$bog_quest_editor.prototype), "Graph_view"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_quest_editor extends $.$bog_quest_editor {
            store() { return $bog_quest_store.make({ $: this.$ }); }
            game_link() {
            ...
            editor_rows() {
                if (!this.game())
                    return [this.No_game()];
                if (this.current_panel() === 'graph')
                    return [this.Back_link(), this.Graph_view()];
                if (this.current_scene_key())
                    return [this.Back_link(), this.Scene_editor()];
                const rows = [
                    this.Game_title(),
                    this.Game_author(),
            ...
            character_at(key) { return this.characters()[Number(key)]; }
            character_name(key, next) {
                const ch = this.character_at(key);
                if (!ch)
                    return '';
                if (next !== undefined) {
                    ch.Name('auto')?.val(next);
                    return next;
                }
                return ch.Name()?.val() ?? '';
            }
            character_color(key, next) {
                const ch = this.character_at(key);
                if (!ch)
                    return '#ffffff';
                if (next !== undefined) {
                    ch.Color('auto')?.val(next);
                    return next;
                }
                return ch.Color()?.val() ?? '#ffffff';
            }
            character_sprite_uri(key) {
                const file = this.character_at(key)?.Sprite()?.remote();
                if (!file)
                    return '';
                return URL.createObjectURL(file.blob());
            }
            character_sprite_files(key, next) {
                if (next?.length) {
                    const ch = this.character_at(key);
                    if (ch) {
            ...
            scene_at(key) { return this.scenes()[Number(key)]; }
            scene_key(key) { return this.scene_at(key)?.link()?.str ?? ''; }
            scene_title(key) {
                return this.scene_at(key)?.Title()?.val() || `Сцена ${Number(key) + 1}`;
            }
            scene_start_label(key) {
                const g = this.game();
                const sc = this.scene_at(key);
                if (!g || !sc)
                    return '';
        ...
        __decorate([
            $mol_mem
        ], $bog_quest_editor.prototype, "store", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor.prototype, "game_link", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor.prototype, "game", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor.prototype, "editor_rows", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor.prototype, "cover_section", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor.prototype, "game_title", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor.prototype, "game_author", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor.prototype, "game_description", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor.prototype, "cover_uri", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor.prototype, "cover_files", null);
        __decorate([
            $mol_action
        ], $bog_quest_editor.prototype, "cover_remove", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor.prototype, "characters", null);
        __decorate([
            $mol_mem_key
        ], $bog_quest_editor.prototype, "character_name", null);
        __decorate([
            $mol_mem_key
        ], $bog_quest_editor.prototype, "character_color", null);
        __decorate([
            $mol_mem_key
        ], $bog_quest_editor.prototype, "character_sprite_uri", null);
        __decorate([
            $mol_mem_key
        ], $bog_quest_editor.prototype, "character_sprite_files", null);
        __decorate([
            $mol_action
        ], $bog_quest_editor.prototype, "character_delete", null);
        __decorate([
            $mol_action
        ], $bog_quest_editor.prototype, "add_character", null);
        __decorate([
            $mol_mem
        ], $bog_quest_editor.prototype, "scenes", null);
        __decorate([
            $mol_action
        ], $bog_quest_editor.prototype, "scene_set_start", null);
        __decorate([
            $mol_action
        ], $bog_quest_editor.prototype, "scene_delete", null);
        __decorate([
            $mol_action
        ], $bog_quest_editor.prototype, "add_scene", null);
        $$.$bog_quest_editor = $bog_quest_editor;
        /** Сжатие через canvas — webp по умолчанию, для не-прозрачных подойдёт jpeg. */
        function $bog_quest_compress(file, max_size = 1024, quality = 0.85, mime = 'image/webp') {
            return new Promise((resolve, reject) => {
                ...
                img.onload = () => {
                    ...
                    canvas.toBlob(blob => blob ? resolve(blob) : reject(new Error('compress failed')), mime, quality);
                };
                img.onerror = reject;
                img.src = URL.createObjectURL(file);
            });
        }
        $$.$bog_quest_compress = $bog_quest_compress;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));

;
	($.$bog_quest_player) = class $bog_quest_player extends ($.$mol_view) {
		player_sub(){
			return [];
		}
		stage_bg(){
		...
		Sprite_center(){
			const obj = new this.$.$mol_image();
			(obj.uri) = () => ((this.sprite_uri_center()));
			return obj;
		}
		sprite_uri_right(){
			return "";
		...
		Speaker_name(){
			const obj = new this.$.$mol_view();
			(obj.style) = () => ({"color": (this.speaker_color())});
			(obj.sub) = () => ([(this.speaker_name())]);
			return obj;
		}
		current_text(){
			return "";
		...
		Line_text(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.current_text())]);
			return obj;
		}
		hint_text(){
			return (this.$.$mol_locale.text("$bog_quest_player_hint_text"));
		}
		Hint(){
			const obj = new this.$.$mol_view();
		...
		End_text(){
			return (this.$.$mol_locale.text("$bog_quest_player_End_text"));
		}
		restart(next){
			if(next !== undefined) return next;
			return null;
		...
		Restart_button(){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_player_Restart_button_title")));
			(obj.click) = (next) => ((this.restart(next)));
			return obj;
		}
		sub(){
			return (this.player_sub());
		}
		Stage(){
			const obj = new this.$.$mol_view();
			(obj.style) = () => ({"backgroundImage": (this.stage_bg())});
			(obj.sub) = () => ([
				(this.Sprite_left()), 
				(this.Sprite_center()), 
				(this.Sprite_right())
		...
		Textbox(){
			const obj = new this.$.$mol_view();
			(obj.event) = () => ({"click": (next) => (this.advance(next))});
			(obj.sub) = () => ([
				(this.Speaker_name()), 
				(this.Line_text()), 
				(this.Hint())
		...
		Choices_panel(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ((this.choice_rows()));
			return obj;
		}
		Choice_button(id){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ((this.choice_label(id)));
			(obj.click) = (next) => ((this.pick_choice(id, next)));
			return obj;
		}
		End_screen(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.End_text()), (this.Restart_button())]);
			return obj;
		}
		Loading(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_player_Loading_title")));
			return obj;
		}
		Not_found(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_quest_player_Not_found_title")));
			return obj;
		}
	};
	($mol_mem(($.$bog_quest_player.prototype), "Sprite_left"));
	($mol_mem(($.$bog_quest_player.prototype), "Sprite_center"));
	($mol_mem(($.$bog_quest_player.prototype), "Sprite_right"));
	($mol_mem(($.$bog_quest_player.prototype), "advance"));
	($mol_mem(($.$bog_quest_player.prototype), "Speaker_name"));
	($mol_mem(($.$bog_quest_player.prototype), "Line_text"));
	($mol_mem(($.$bog_quest_player.prototype), "Hint"));
	($mol_mem_key(($.$bog_quest_player.prototype), "pick_choice"));
	($mol_mem(($.$bog_quest_player.prototype), "restart"));
	($mol_mem(($.$bog_quest_player.prototype), "Restart_button"));
	($mol_mem(($.$bog_quest_player.prototype), "Stage"));
	($mol_mem(($.$bog_quest_player.prototype), "Textbox"));
	($mol_mem(($.$bog_quest_player.prototype), "Choices_panel"));
	($mol_mem_key(($.$bog_quest_player.prototype), "Choice_button"));
	($mol_mem(($.$bog_quest_player.prototype), "End_screen"));
	($mol_mem(($.$bog_quest_player.prototype), "Loading"));
	($mol_mem(($.$bog_quest_player.prototype), "Not_found"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_quest_player extends $.$bog_quest_player {
            store() { return $bog_quest_store.make({ $: this.$ }); }
            ...
            game() {
                ...
                const id = this.game_id();
                if (!reg || !id)
                    return null;
                const games = reg.Games()?.remote_list() ?? [];
                return (games.find(g => g.link().str === id) ?? null);
            }
            save() {
                const author = this.author_link();
                const id = this.game_id();
                if (!author || !id)
                    return null;
                ...
                if (!found) {
                    ...
                    if (!start)
                        return null;
                    const sv = this.store().saves().Items('auto').make(null);
            ...
            current_scene() {
                ...
                return (scenes.find(s => s.link().str === sid) ?? null);
            }
            current_lines() {
            ...
            player_sub() {
                if (!this.game()) {
                    if (!this.author_link() || !this.game_id())
                        return [this.Not_found()];
                    return [this.Loading()];
                }
                if (this.game_ended())
                    return [this.End_screen()];
                const sub = [this.Stage()];
                if (this.lines_done()) {
            ...
            character_by_id(id) {
                const chars = this.game()?.Characters()?.remote_list() ?? [];
                return (chars.find(c => c.link().str === id) ?? null);
            }
            sprite_uri_for(position) {
            ...
            choice_label(key) {
                const c = this.current_choices()[Number(key)];
                return c?.Text()?.val() ?? '';
            }
            pick_choice(key) {
                const c = this.current_choices()[Number(key)];
        ...
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "store", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "author_link", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "game_id", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "registry", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "game", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "save", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "current_scene", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "current_lines", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "current_line", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "current_choices", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "game_ended", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "lines_done", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "player_sub", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "stage_bg", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "sprite_uri_left", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "sprite_uri_center", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "sprite_uri_right", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "speaker_name", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "speaker_color", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "current_text", null);
        __decorate([
            $mol_mem
        ], $bog_quest_player.prototype, "choice_rows", null);
        __decorate([
            $mol_action
        ], $bog_quest_player.prototype, "pick_choice", null);
        __decorate([
            $mol_action
        ], $bog_quest_player.prototype, "advance", null);
        __decorate([
            $mol_action
        ], $bog_quest_player.prototype, "restart", null);
        $$.$bog_quest_player = $bog_quest_player;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_quest_app) = class $bog_quest_app extends ($.$mol_page) {
		Home(){
			const obj = new this.$.$bog_quest_home();
			return obj;
		}
		Editor(){
			const obj = new this.$.$bog_quest_editor();
			return obj;
		}
		Player(){
			const obj = new this.$.$bog_quest_player();
			return obj;
		}
		screen(next){
			if(next !== undefined) return next;
		...
		title(){
			return (this.$.$mol_locale.text("$bog_quest_app_title"));
		}
		pages(){
			return {
				"home": (this.Home()), 
		...
		nav_options(){
			return {"home": (this.$.$mol_locale.text("$bog_quest_app_nav_options_home")), "edit": (this.$.$mol_locale.text("$bog_quest_app_nav_options_edit"))};
		}
		Navbar(){
	...
	($mol_mem(($.$bog_quest_app.prototype), "Home"));
	($mol_mem(($.$bog_quest_app.prototype), "Editor"));
	($mol_mem(($.$bog_quest_app.prototype), "Player"));
	($mol_mem(($.$bog_quest_app.prototype), "screen"));
	($mol_mem(($.$bog_quest_app.prototype), "Status"));
	($mol_mem(($.$bog_quest_app.prototype), "Theme_toggle"));
	($mol_mem(($.$bog_quest_app.prototype), "Theme"));
	($mol_mem(($.$bog_quest_app.prototype), "Navbar"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_quest_app extends $.$bog_quest_app {
            store() {
        ...
        __decorate([
            $mol_mem
        ], $bog_quest_app.prototype, "store", null);
        __decorate([
            $mol_mem
        ], $bog_quest_app.prototype, "screen", null);
        __decorate([
            $mol_mem
        ], $bog_quest_app.prototype, "screen_body", null);
        $$.$bog_quest_app = $bog_quest_app;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
var $;
(function ($) {
    $mol_style_define($bog_quest_app, {});
})($ || ($ = {}));
